...
sdecompile = loadstring(game:HttpGet("https://raw.githubusercontent.com/w-a-e/Advanced-Decompiler-V3/main/init.lua"))()
...
SaveMapButton.MouseButton1Click:connect(function()
	...
	if sdecompile and copyScripts then
...
function openScript(scrObj)
	...
	local scrSource = sdecompile(scrObj)
